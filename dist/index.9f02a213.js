...
${frame.code}`;
    ...
    lqflI: [
      function (require, module, exports) {
        ...
        (0, _preactCustomElementDefault.default)(
      ...
      {
        preact: "a3Kg2",
        "preact-custom-element": "5kh15",
        clsx: "3cPI2",
        "bundle-text:./styles.css": "ffcQC",
        "./contrastColor": "hxoDj",
        "./darkenColor": "6WYoE",
        "./data.yaml": "flUmO",
        "./isDark": "inbRE",
        "@parcel/transformer-js/src/esmodule-helpers.js": "6elpC",
      },
    ],
    a3Kg2: [
      function (require, module, exports) {
            ...
            ((r = t + a),
              ...
              (i = n.__k[t] =
                ...
                : (o = u[r]) &&
                  ...
                  o.__e &&
                  0 == (131072 & o.__u) &&
                  (o.__e == n.__d && (n.__d = m(o)), N(o, o, !1), (u[r] = null), s--));
          if (s)
            for (t = 0; t < c; t++)
              null != (o = u[t]) &&
                0 == (131072 & o.__u) &&
          ...
          n: if ("function" == typeof A)
            try {
              if (
                ...
                t.__c
                  ...
                  : ("prototype" in A && A.prototype.render
                      ? (u.__c = p = new A(k, P))
                      : ((u.__c = p = new b(k, P)), (p.constructor = A), (p.render = O)),
                    x && x.sub(p),
                    (p.props = k),
                    p.state || (p.state = {}),
                    (p.context = P),
                ...
                null != A.getDerivedStateFromProps &&
                  ...
                  v(p.__s, A.getDerivedStateFromProps(k, p.__s))),
                (d = p.props),
                (_ = p.state),
                (p.__v = u),
                y)
                ...
                if (
                  (null == A.getDerivedStateFromProps &&
                    ...
                    p.componentWillReceiveProps(k, P),
                  !p.__e &&
                    ((null != p.shouldComponentUpdate &&
                      !1 === p.shouldComponentUpdate(k, p.__s, P)) ||
                      u.__v === t.__v))
                ) {
                  for (
                    u.__v !== t.__v && ((p.props = k), (p.state = p.__s), (p.__d = !1)),
                      u.__e = t.__e,
                      u.__k = t.__k,
                ...
                (null != p.componentWillUpdate && p.componentWillUpdate(k, p.__s, P),
              ...
              ((p.state = p.__s),
                ...
                C(
                  n,
                  h((T = null != a && a.type === g && null == a.key ? a.props.children : a))
                    ? T
                    : [T],
                  u,
                  t,
        ...
        function j(l, u, t, i, o, r, f, e, s) {
          ...
          if (null === x) w === k || (e && l.data === k) || (l.data = k);
            ...
            if (((r = r && n.call(l.childNodes)), (w = t.props || c), !e && null != r))
              for (w = {}, a = 0; a < l.attributes.length; a++)
            ...
            e ||
              ((a = "value"),
              void 0 !== g &&
                (g !== l[a] || ("progress" === x && !g) || ("option" === x && g !== w[a])) &&
                T(l, a, g, w[a], !1),
              (a = "checked"),
              void 0 !== b && b !== l[a] && T(l, a, b, w[a], !1));
          }
          return l;
        }
        function z(n, u, t) {
    ...
    "5kh15": [
          ...
          () =>
            function (t, e, n, o) {
              ...
              return (
                ...
                (r.prototype.disconnectedCallback = u),
      ...
      { preact: "a3Kg2", "@parcel/transformer-js/src/esmodule-helpers.js": "6elpC" },
    ],
    "3cPI2": [
      function (require, module, exports) {
        var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    ...
    "6WYoE": [
      function (require, module, exports) {
        ...
        function darkenColor(color, percent) {
          ...
          if (color[0] === "#" && (color.length === 9 || color.length === 5))
            return `#${(16777216 + (R << 16) + (G << 8) + B).toString(16).slice(1)}${(A * 255).toString(16).padStart(2, "0")}`;
          else if (color[0] === "#")
