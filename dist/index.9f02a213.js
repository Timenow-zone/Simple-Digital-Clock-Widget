...
const defaultBackgroundColor = (0, _isDarkDefault.default)() ? "#000000" : "#ffffff";
class SimpleDigitalClockWidget extends (0, _preact.Component) {
    ...
    render() {
        ...
        const mainStyle = {
            color: (0, _contrastColorDefault.default)(backgroundColor?.toLowerCase() || defaultBackgroundColor),
            ...background ? {
                background: background?.toLowerCase() || defaultBackgroundColor
            } : {
        ...
        return /*#__PURE__*/ (0, _preact.h)((0, _preact.Fragment), {
            ...
            style: {
                ...
                ...border !== undefined && {
                    borderColor: (0, _darkenColorDefault.default)(backgroundColor?.toLowerCase() || defaultBackgroundColor, -0.25),
                    borderWidth: "1px"
                },
                minWidth: 80,
                ...width !== undefined && {
...
},{"preact":"7YeNw","preact-custom-element":"62FID","clsx":"dlwGi","bundle-text:./styles.css":"iMJvs","./contrastColor":"hxoDj","./darkenColor":"6WYoE","./data.yaml":"flUmO","@parcel/transformer-js/src/esmodule-helpers.js":"gEup9","./isDark":"inbRE"}],"7YeNw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
